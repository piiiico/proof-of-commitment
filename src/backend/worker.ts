    ...
    packages.map(async (pkg) => {
      try {
        if (usePypi) {
          ...
          if (!profile) return { name: pkg, ecosystem: "pypi", score: null, maintainers: null, githubContributors: null, weeklyDownloads: null, ageYears: null, trend: null, daysSinceLastPublish: null, hasProvenance: null, riskFlags: [], scoreBreakdown: null, error: "not found" };
          ...
          return { name: profile.name, ecosystem: "pypi", score: profile.commitmentScore, maintainers: profile.maintainerCount, githubContributors: null, weeklyDownloads: weeklyDl, ageYears: Math.round(profile.ageYears * 10) / 10, trend: profile.downloadTrend, daysSinceLastPublish: profile.daysSinceLastPublish, hasProvenance: null, riskFlags, scoreBreakdown: profile.scoreBreakdown };
        } else {
          ...
          if (!profile) return { name: pkg, ecosystem: "npm", score: null, maintainers: null, githubContributors: null, weeklyDownloads: null, ageYears: null, trend: null, daysSinceLastPublish: null, hasProvenance: null, riskFlags: [], scoreBreakdown: null, error: "not found" };
          const riskFlags: string[] = [];
          ...
          return { name: profile.name, ecosystem: "npm", score: profile.commitmentScore, maintainers: profile.maintainerCount, githubContributors: profile.githubContributors, weeklyDownloads: profile.recentWeeklyDownloads ?? null, ageYears: Math.round(profile.ageYears * 10) / 10, trend: profile.downloadTrend, daysSinceLastPublish: profile.daysSinceLastPublish, hasProvenance: profile.hasProvenance, riskFlags, scoreBreakdown: profile.scoreBreakdown };
        }
      } catch (err) {
        return { name: pkg, ecosystem: usePypi ? "pypi" : "npm", score: null, maintainers: null, githubContributors: null, weeklyDownloads: null, ageYears: null, trend: null, daysSinceLastPublish: null, hasProvenance: null, riskFlags: [], scoreBreakdown: null, error: err instanceof Error ? err.message : "error" };
      }
    })
  );
